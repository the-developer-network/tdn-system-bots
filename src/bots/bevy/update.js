/**
 * @module bots/bevy/update
 * @description Bevy Engine update bot.
 * Monitors the bevyengine/bevy GitHub repository for new releases
...
/** @type {BaseUpdateWatcher} Bevy release watcher (60-minute interval) */
const watcher = new BaseUpdateWatcher({
    name: "Bevy-Update",
    githubRepo: "bevyengine/bevy",
    stateDir: __dirname,
    intervalMinutes: 60,
});
...
/**
 * Starts the Bevy update bot.
 * Polls GitHub releases every 60 minutes.
 */
export function startBevyUpdatesBot() {
    watcher.start();
}
