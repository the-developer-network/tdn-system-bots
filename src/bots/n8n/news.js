/**
 * @module bots/n8n/news
 * @description n8n news bot.
 * Monitors the n8n blog RSS feed and publishes
...
const RSS_URL = "https://blog.n8n.io/rss/";
...
watcher.on("new_article", async (news) => {
    log("N8N-News-Bot", "INFO", `Preparing payload for: ${news.title}`);
...
export function startN8NNewsBot() {
    watcher.start();
}
