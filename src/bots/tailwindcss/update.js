/**
 * @module bots/tailwindcss/update
 * @description Tailwind CSS update bot.
 * Monitors the tailwindlabs/tailwindcss GitHub repository for new releases
...
/** @type {BaseUpdateWatcher} Tailwind CSS release watcher (60-minute interval) */
...
/**
 * Starts the Tailwind CSS update bot.
 * Polls GitHub releases every 60 minutes.
 */
export function startTailwindUpdatesBot() {
    watcher.start();
}
