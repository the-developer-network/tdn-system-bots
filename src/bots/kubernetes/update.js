/**
 * @module bots/kubernetes/update
 * @description Kubernetes update bot.
 * Monitors the kubernetes/kubernetes GitHub repository for new releases
...
/** @type {BaseUpdateWatcher} Kubernetes release watcher (60-minute interval) */
...
/**
 * Starts the Kubernetes update bot.
 * Polls GitHub releases every 60 minutes.
 */
export function startKubernetesUpdatesBot() {
    watcher.start();
}
