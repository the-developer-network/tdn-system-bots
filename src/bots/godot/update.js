/**
 * @module bots/godot/update
 * @description Godot Engine update bot.
 * Monitors the godotengine/godot GitHub repository for new releases
...
/** @type {BaseUpdateWatcher} Godot release watcher (60-minute interval) */
const watcher = new BaseUpdateWatcher({
    name: "Godot-Update",
    githubRepo: "godotengine/godot",
    stateDir: __dirname,
    intervalMinutes: 60,
});
...
/**
 * Starts the Godot update bot.
 * Polls GitHub releases every 60 minutes.
 */
export function startGodotUpdatesBot() {
    watcher.start();
}
