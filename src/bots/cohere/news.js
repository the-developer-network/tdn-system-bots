/**
 * @module bots/cohere/news
 * @description Cohere news bot.
 * Monitors the Cohere blog RSS feed and publishes
...
const RSS_URL = "https://cohere.com/blog/rss";
...
watcher.on("new_article", async (news) => {
    log("Cohere-News-Bot", "INFO", `Preparing payload for: ${news.title}`);
...
export function startCohereNewsBot() {
    watcher.start();
}
