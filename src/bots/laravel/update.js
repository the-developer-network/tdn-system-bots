/**
 * @module bots/laravel/update
 * @description Laravel update bot.
 * Monitors the laravel/framework GitHub repository for new releases
...
/** @type {BaseUpdateWatcher} Laravel release watcher (60-minute interval) */
...
/**
 * Starts the Laravel update bot.
 * Polls GitHub releases every 60 minutes.
 */
export function startLaravelUpdatesBot() {
    watcher.start();
}
