/**
 * @module bots/svelte/update
 * @description Svelte update bot.
 * Monitors the sveltejs/svelte GitHub repository for new releases
...
/** @type {BaseUpdateWatcher} Svelte release watcher (60-minute interval) */
...
/**
 * Starts the Svelte update bot.
 * Polls GitHub releases every 60 minutes.
 */
export function startSvelteUpdatesBot() {
    watcher.start();
}
