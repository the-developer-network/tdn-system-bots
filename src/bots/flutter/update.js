/**
 * @module bots/flutter/update
 * @description Flutter update bot.
 * Monitors the flutter/flutter GitHub repository for new releases
...
/** @type {BaseUpdateWatcher} Flutter release watcher (60-minute interval) */
...
/**
 * Starts the Flutter update bot.
 * Polls GitHub releases every 60 minutes.
 */
export function startFlutterUpdatesBot() {
    watcher.start();
}
